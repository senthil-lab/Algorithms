...
class LinkedList:
    ...
    #             if temp.value < x:
    #                 dummy1 = Node(temp.value)
    #                 if dummy1_head is None:
    #                     dummy1_head =  dummy1
    #                 else:
    #                     dummy1_temp.next = dummy1
    #                 dummy1_temp = dummy1
    #             else:
    #                 dummy2 = Node(temp.value)
    #                 if dummy2_head is None:
    #                     dummy2_head =  dummy2
    #                 else:
    #                     dummy2_temp.next = dummy2
    #                 dummy2_temp = dummy2
    #             temp = temp.next
    #         self.make_empty()
    #         if dummy1_head is not None :
    #             dummy1_temp.next = dummy2_head
    #             self.head = dummy1_head
    #         else:
    #             self.head = dummy2_head
    #     return True

    # my second approach - correct
    # def partition_list(self, x):
    #     if self.head is not None:
    #         temp = self.head
    #         dummy1_head = None
    ...
    #         else:
    #             self.head = dummy2_head
    #         if dummy2_head is not None:
    #             dummy2_temp.next = None
    #     return True
    ...
    def partition_list(self, x):
        ...
        # prev1.next = None this can be commented.
        prev2.next = None
